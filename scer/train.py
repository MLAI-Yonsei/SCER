...
from scer import hparams_registry
from scer.dataset import datasets
from scer.learning import algorithms, early_stopping
from scer.utils import misc, eval_helper
from scer.dataset.fast_dataloader import InfiniteDataLoader, FastDataLoader
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cmnist_spur_prob', type=float, default=0.01)
