...
from scer import command_launchers
from scer.dataset import datasets
from scer.learning import algorithms, model_selection
from scer.utils import reporting
...
def load_best_hparams(all_records, dataset, algo):
    ...
    selection_method = model_selection.OracleWorstAcc
